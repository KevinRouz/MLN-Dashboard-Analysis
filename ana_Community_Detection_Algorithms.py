...
def louvain(G):
    ...
    # calulating the number of edges
    numEdges = len(G.edges())
    # calculating the modularity
    numCommunities = max(partition.values()) + 1

    return partition, t1, numNodes, numEdges, numCommunities    
...
def fastgreedy(G, edgeWeights):
    ...
    return result, t1, numCommunities
